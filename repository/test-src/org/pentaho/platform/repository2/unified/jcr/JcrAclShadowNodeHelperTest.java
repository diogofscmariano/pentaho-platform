...
import static org.pentaho.platform.repository2.unified.jcr.IAclShadowNodeHelper.DatasourceType.MONDRIAN;

@RunWith( SpringJUnit4ClassRunner.class )
@ContextConfiguration( locations = { "classpath:/repository.spring.xml",
  "classpath:/repository-test-override.spring.xml" } )
public class JcrAclShadowNodeHelperTest extends DefaultUnifiedRepositoryBase {

  private static final String DS_NAME = "test.txt";

  private JcrAclShadowNodeHelper helper;
  ...
  public void setUp() throws Exception {
    ...
    helper = new JcrAclShadowNodeHelper( repo, repositoryFileAclDao, ClientRepositoryPaths.getPublicFolderPath() );
  }
  ...
  @Test
  public void shadowNodeIsCreated() {
    makeDsPrivate();
    loginAsSuzy();
    assertNotNull( repo.getFile( helper.getShadowFolder() + "/" + MONDRIAN.resolveName( DS_NAME ) ) );
  }

  @Test
  public void shadowNodeIsRemoved() {
    makeDsPrivate();
    loginAsSuzy();
    helper.setAclFor( DS_NAME, MONDRIAN, null );
    assertNull( repo.getFile( helper.getShadowFolder() + "/" + MONDRIAN.resolveName( DS_NAME ) ) );
  }
